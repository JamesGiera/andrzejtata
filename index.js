...
const SEARCHES = [
  'DLACZEGO NIE JESTEM SIGMA'
]

const VIDEOS = [
    'andrew-tate.gif',
    'andrew-tate-top-g.gif',
    'andrew-tate (1).gif'
  ]

const FILE_DOWNLOADS = [
'images (2).jpeg', //added by @imzeme
'images (3).jpeg', //added by @imzeme
'images (4).jpeg', //added by @imzeme
'images (5).jpeg', //added by @imzem
'images (1).jpeg', //added by @imzeme
'images.jpeg' //added by @imzeme
]

const PHRASES = [
  'jestes beta i nic tego nie zmieni'
]
